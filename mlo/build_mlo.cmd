...
echo [1/7] BUILD BASE ARCHITECTURE
...
echo [2/7] OPTIMIZE BASE MLO
"D:\blender.exe" --background --python "D:\first Blender\mlo\scripts\optimize_mlo.py"
if errorlevel 1 exit /b 1
"D:\blender.exe" --background --python "D:\first Blender\mlo\scripts\validate_mlo.py"
if errorlevel 1 exit /b 1

echo [3/7] ADD DETAIL WITHOUT REPLACING ARCHITECTURE
...
echo [7/7] MLO BUILD SUCCESS - REAL INTERIOR + COLOR CHECKPOINT VALIDATED
exit /b 0
